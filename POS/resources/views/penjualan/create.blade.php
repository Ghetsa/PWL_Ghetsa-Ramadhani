  ...
  <div class="card card-outline card-primary">
    ...
    @enderror
      ...
      <div class="col-10 offset-2">
        <button type="button" class="btn btn-secondary btn-sm" id="addBarang">Tambah Barang</button>
      </div>
      </div>
...
@push('js')
  <script>
    ...
    $('#addBarang').on('click', function () {
      ...
      barangDetail.find('input').val('');  // Clear input values
      $('#barangDetails').append(barangDetail);  // Append new item
    });
