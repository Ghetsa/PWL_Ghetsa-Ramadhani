  ...
  <div id="modal-master" class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="file_penjualan" class="font-weight-bold">Pilih File</label>
          <div class="custom-file">
            <input type="file" class="custom-file-input" id="file_penjualan" name="file_penjualan">
            <label class="custom-file-label" for="file_penjualan">Choose file</label>
          </div>
